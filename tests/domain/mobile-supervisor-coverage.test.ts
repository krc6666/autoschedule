...
import { evaluateMobileSupervisorCoverage } from "../../src/domain/coverage/mobile-supervisor-coverage";
...
describe("mobile supervisor coverage rules", () => {
  it("forbids the default remarked positions", () => {
    ...
    ).toEqual({ allowed: true, reason: null, rule: null });
  });
