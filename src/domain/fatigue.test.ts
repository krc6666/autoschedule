...
import { consecutiveWorkDays, historyFatigue, recentArchivedWorkdays, recentHistory } from "./fatigue";
...
describe("fatigue domain", () => {
  ...
  it("selects the latest archived workdays instead of calendar days", () => {
    const records = [record("2026-07-10"), record("2026-07-14"), record("2026-07-18")];
    expect(recentArchivedWorkdays(records, "2026-07-20", 2).map((item) => item.date)).toEqual(["2026-07-14", "2026-07-18"]);
  });
