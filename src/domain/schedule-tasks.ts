...
export function mustAutoFillPreNoon(flight: Flight, rule: PositionRule): boolean {
  return isPreNoonFlight(flight) && rule.category === "常规";
}

export function isKe166MobileSupervisor(flight: Flight, rule: PositionRule): boolean {
