...
export function assignmentRule(state: AppState, assignment: Assignment): PositionRule | undefined {
...
export function isReusableAssignment(state: AppState, assignment: Assignment): boolean {
  return isGuideAssignment(state, assignment);
}

export function makeUnfilled(flight: Flight, position: string, rule: PositionRule | undefined): Assignment {
  return {
